...
public class StreamTest {
    ...
    public static void main(String[] args) {
        ...
        Optional<Student> bob = students.stream().filter(s -> s.getName().equals("Bob")).findFirst();
        ...
        Optional<Student> s1 = students.stream().filter(s -> s.getAddress().getZipcode().equals("1235")).findFirst();
        ...
        List<Student> studentsWith3333 = students.stream()
            .filter(s -> s.getMobileNumbers().stream().anyMatch(num -> num.getNumber().equals("3333")))
